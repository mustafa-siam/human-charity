...
export default function GalleryPage() {
  ...
  if (loading) {
    return (
      <div className="flex flex-col justify-center items-center h-screen gap-6 bg-gradient-to-b from-[#f0fdf4] to-[#ffffff]">
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-16">
          {galleryCategories.map((cat) => (
            <button
              ...
              className={`px-5 py-2 rounded-full font-medium cursor-pointer transition-all duration-300 text-sm ${selectedCategory === cat.id
